...
namespace IOAS.DataModel
{
    ...
    public partial class tblOverheadsPostingSWFDetails
    {
        public int Id { get; set; }
        public Nullable<int> ReceiptId { get; set; }
        public Nullable<int> OverheadsPostingId { get; set; }
        public string ReceiptNumber { get; set; }
        public Nullable<int> SWFProjectID { get; set; }
        public Nullable<int> SWFBankId { get; set; }
        public Nullable<decimal> SWFAmount { get; set; }
