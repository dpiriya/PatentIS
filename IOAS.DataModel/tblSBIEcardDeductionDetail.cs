...
namespace IOAS.DataModel
{
    ...
    public partial class tblSBIEcardDeductionDetail
    {
        public int SBIEcardDeductionDetailId { get; set; }
        public Nullable<int> EcardId { get; set; }
        public Nullable<int> EcardProjectId { get; set; }
